...
bezie((width//2,0), (width,0), (2*width//3,height), (2*width//5,height))
bezie((width//2,0), (width//5,0), (width//5,4*height//5), (4*width//7,3*height//5))
bezie((4*width//7,3*height//5), ((4*width//7,5*height//8)),(9*width//16,4*height/5), (2*width//5,height))
image.show()
