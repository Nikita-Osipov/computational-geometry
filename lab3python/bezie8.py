...
bezie((width//2,0), (width//2,height//4), (width//5,height//5), (width//5,height//5)) 
bezie((width//2,0), (width//2,height//4), (4*width//5,height//5), (4*width//5,height//5))
bezie((4*width//5,height//5), (width,height//5), (width,height//2), (3*width//4,3*height//4))
bezie((width//5,height//5), (0,height//5), (0,height//2), (width//4,3*height//4))
bezie((width//4,3*height//4), (width//4,3*height//4), (width//2,14*height//15), (width//2,height))
bezie((3*width//4,3*height//4), (3*width//4,3*height//4), (width//2,14*height//15), (width//2,height))
image.show() 
